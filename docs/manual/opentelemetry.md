...
| `activitypub.delivery.success`            | boolean  | Whether an outgoing delivery attempt received a successful response.                                                                | `true`                                                               |
...
| `activitypub.verification.failure_reason` | string   | Why HTTP signature verification failed (`noSignature`, `invalidSignature`, `keyFetchError`, `actorKeyMismatch`, or `invalidNonce`). | `"keyFetchError"`                                                    |

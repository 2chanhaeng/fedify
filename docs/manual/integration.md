...
[AdonisJS] is a batteries-included Node.js framework with a first-class server
middleware stack. The _@fedify/adonisjs_ package provides a middleware factory
that plugs Fedify into AdonisJS server middleware:
...
_This integration currently supports AdonisJS 6.x._

...
/** Supported web framework identifiers: `"hono"`, `"nitro"`, `"next"`, `"elysia"`, `"astro"`, `"express"`, `"solidstart"`, `"adonisjs"`. */
 ...
 * ElysiaJS, Astro, SolidStart, AdonisJS) and how to initialize a project
 * with it.
 */
